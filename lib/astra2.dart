...
class _CarvTheatrePageState extends State<CarvTheatrePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ASTRA Robotics Club'),
        centerTitle: true,
        actions: [
          IconButton(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          const Center(
              child: Text('Other Page', style: TextStyle(fontSize: 20))),
        ],
      ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                const Text(
                  'Astra is the one and only place to see robots and play with them',
                ...
                GridView.count(
                  ...
                  children: List.generate(
                      6,
                      (index) =>
                          PhotoTile(imagePath: 'assets/gallery$index.jpg')),
                ),
                const SizedBox(height: 24),
                Row(
                  children: [
